      ...
      <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
        ...
        >
          <div class="p-5">
            <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
              <a href="#">Shahm AlJuaid</a>
            </h3>
            <span class="text-gray-500 dark:text-gray-400">CEO & Web Developer</span>
            <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
              Shahm is our team leader who orchestrate and balances the tone of the team.
            </p>
        ...
        >
          <div class="p-5">
            ...
            <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
              Meshal is the core designer of the user experience through our website!
            </p>
            <ul class="flex space-x-4 sm:mt-0">
              <li>
                <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
        ...
        >
          <div class="p-5">
            <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
              <a href="#">Kayan AlJuaid</a>
            </h3>
            <span class="text-gray-500 dark:text-gray-400">Web Developer</span>
            <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
              Kayan with his unique perspective provides a taste and ease into our pages!
            </p>
            <ul class="flex space-x-4 sm:mt-0">
              <li>
                <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
