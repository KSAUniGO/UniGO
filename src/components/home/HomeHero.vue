<template>
  <section class="bg-white dark:bg-gray-900 lg:py-16">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12">
      <div class="mr-auto place-self-center lg:col-span-7">
        <h1
          class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white"
        >
          Navigate Your University Journey
        </h1>
        <p
          class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400"
        >
          Effortless rides, seamless strides, University ride simplified with every ride.
        </p>
        <a
          href="#"
      ...
      <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
        <img src="@/assets/img/bus-0.png" alt="mockup" />
      </div>
    </div>
    <div class="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg">
      ...
      <div class="flex flex-wrap justify-center items-center mt-8 text-gray-500 sm:justify-evenly">
        ...
        <a href="#" class="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400">
          <img class="max-h-28" src="./../../assets/img/uni/umm-al-qura-uni.png" />
        </a>
      </div>
    </div>
  </section>
